 ...
 * @since 2.5
 */
final class FluxionWindowStartEnd<T, U, V> extends FluxionSource<T, Fluxion<T>> {
	...
	public FluxionWindowStartEnd(Publisher<? extends T> source, Publisher<U> start,
	...
	implements Subscriber<T>, Subscription, Runnable {
		...
		public WindowStartEndMainSubscriber(Subscriber<? super Fluxion<T>> actual, Queue<Object> queue,

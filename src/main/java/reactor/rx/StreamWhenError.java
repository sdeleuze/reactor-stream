 ...
 * @since 1.1, 2.0, 2.5
 */
final class StreamWhenError<T, E extends Throwable> extends StreamSource<T, T> {

	private final Consumer<? super E> consumer;
	private final Class<E>            selector;

	public StreamWhenError(Publisher<T> source, Class<E> selector, Consumer<? super E> consumer) {
		super(source);

 ...
 * @since 2.5
 */
final class FluxionWindowBoundary<T, U> extends FluxionSource<T, Fluxion<T>> {
	...
	public FluxionWindowBoundary(Publisher<? extends T> source, Publisher<U> other,
	...
	static final class WindowBoundaryMain<T, U>
		...
		public WindowBoundaryMain(Subscriber<? super Fluxion<T>> actual,
				Supplier<? extends Queue<T>> processorQueueSupplier,

 ...
 * @since 2.5
 */
final class StreamTakeWhile<T> extends StreamBarrier<T, T> {
	...
	static final class TakeWhileSubscriber<T> implements Subscriber<T>, Subscribable, Completable, Connectable {

 ...
 * @since 2.5
 */
final class FluxionDistinct<T, K, C extends Collection<? super K>> extends FluxionSource<T, T> {

	final Function<? super T, ? extends K> keyExtractor;

	final Supplier<C> collectionSupplier;

	public FluxionDistinct(Publisher<? extends T> source, Function<? super T, ? extends K> keyExtractor,

...
final class StreamAutoConnect<T> extends Stream<T>
	...
	static final AtomicIntegerFieldUpdater<StreamAutoConnect> REMAINING =
			AtomicIntegerFieldUpdater.newUpdater(StreamAutoConnect.class, "remaining");


	public StreamAutoConnect(ConnectableStream<? extends T> source,

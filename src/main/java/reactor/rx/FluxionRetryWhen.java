 ...
 * @since 2.5
 */
final class FluxionRetryWhen<T> extends FluxionSource<T, T> {

	final Function<? super Fluxion<Throwable>, ? extends Publisher<? extends Object>> whenSourceFactory;

	public FluxionRetryWhen(Publisher<? extends T> source,
							  Function<? super Fluxion<Throwable>, ? extends Publisher<? extends Object>> whenSourceFactory) {
		super(source);

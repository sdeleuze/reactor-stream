 ...
 * @since 2.5
 */
final class FluxionAutoConnect<T> extends Fluxion<T>
		implements Receiver {
	...
	static final AtomicIntegerFieldUpdater<FluxionAutoConnect> REMAINING =
			AtomicIntegerFieldUpdater.newUpdater(FluxionAutoConnect.class, "remaining");


	public FluxionAutoConnect(ConnectableFluxion<? extends T> source,

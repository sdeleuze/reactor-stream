 ...
 * @since 2.5
 */
final class FluxionDistinctUntilChanged<T, K> extends FluxionSource<T, T> {

	final Function<? super T, K> keyExtractor;

	public FluxionDistinctUntilChanged(Publisher<? extends T> source, Function<? super T, K> keyExtractor) {
		super(source);

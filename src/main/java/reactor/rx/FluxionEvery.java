 ...
 * @since 2.0, 2.5
 */
final class FluxionEvery<T> extends FluxionBatch<T, T> {

	public FluxionEvery(Publisher<T> source, int maxSize) {
		this(source, maxSize, false);
	}

	public FluxionEvery(Publisher<T> source, int maxSize, boolean first) {

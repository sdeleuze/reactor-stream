 ...
 * @since 2.5
 */
final class FluxionDrop<T> extends FluxionSource<T, T> {
	...
	public FluxionDrop(Publisher<? extends T> source) {
		super(source);
		this.onDrop = NOOP;
	}


	public FluxionDrop(Publisher<? extends T> source, Consumer<? super T> onDrop) {
		super(source);

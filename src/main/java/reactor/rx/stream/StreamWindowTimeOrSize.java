 ...
 * @since 2.0, 2.5
 */
public class StreamWindowTimeOrSize<T> extends StreamBatch<T, Stream<T>> {

	protected final Timer timer;

	public StreamWindowTimeOrSize(Publisher<T> source, Timer timer, int backlog) {
		super(source, backlog, true, true, true);
		this.timer = timer;
	}

	public StreamWindowTimeOrSize(Publisher<T> source, int backlog, long timespan, TimeUnit unit, Timer timer) {

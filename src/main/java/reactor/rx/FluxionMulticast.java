 ...
 * @since 2.5
 */
final class FluxionMulticast<T, U> extends ConnectableFluxion<U> implements Receiver, Producer {

	final Publisher<T>                                           source;
	final Supplier<? extends Processor<? super T, ? extends T>>  processorSupplier;
	final Function<Fluxion<T>, ? extends Publisher<? extends U>> selector;

	volatile State<T, U> connection;
	@SuppressWarnings("rawtypes")
	static final AtomicReferenceFieldUpdater<FluxionMulticast, State> CONNECTION =
			AtomicReferenceFieldUpdater.newUpdater(FluxionMulticast.class, State.class, "connection");

	FluxionMulticast(Publisher<T> source,
			Supplier<? extends Processor<? super T, ? extends T>> processorSupplier,
			Function<Fluxion<T>, ? extends Publisher<? extends U>> selector) {

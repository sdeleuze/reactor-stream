...
public class StreamZipIterableTest {

	@Test(expected = NullPointerException.class)
	public void sourceNull() {
		new StreamZipIterable<>(null, Collections.emptyList(), (a, b) -> a);
	}

	@Test(expected = NullPointerException.class)
	public void iterableNull() {
		new StreamZipIterable<>(Stream.never(), null, (a, b) -> a);
	}

	@Test(expected = NullPointerException.class)
	public void zipperNull() {
		new StreamZipIterable<>(Stream.never(), Collections.emptyList(), null);
	}
	...
	public void normalSameSize() {
		...
		new StreamZipIterable<>(new StreamRange(1, 5), 
	...
	public void normalSourceShorter() {
		...
		new StreamZipIterable<>(new StreamRange(1, 4), 
				Arrays.asList(10, 20, 30, 40, 50), (a, b) -> a + b).subscribe(ts);
	...
	public void sourceEmpty() {
		...
		new StreamZipIterable<>(new StreamRange(1, 0), 
				Arrays.asList(10, 20, 30, 40), (a, b) -> a + b).subscribe(ts);

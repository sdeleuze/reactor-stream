...
public class FluxionRefCountTest {
	/*@Test
	...
	public void normal() {
		...
		Fluxion<Integer> p = sp.publish().refCount();
	...
	public void normalTwoSubscribers() {
		...
		Fluxion<Integer> p = sp.publish().refCount(2);
	...
	public void upstreamCompletes() {
		...
		Fluxion<Integer> p = Fluxion.range(1, 5).publish().refCount();
	...
	public void upstreamCompletesTwoSubscribers() {
		...
		Fluxion<Integer> p = Fluxion.range(1, 5).publish().refCount(2);

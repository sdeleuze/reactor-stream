...
public class FluxionPublishTest {
	...
	public void normal() {
		...
		ConnectableFluxion<Integer> p = Fluxion.range(1, 5).publish();
	...
	public void normalAsyncFused() {
		...
		ConnectableFluxion<Integer> p = up.publish();
	...
	public void disconnect() {
		...
		ConnectableFluxion<Integer> p = sp.publish();
	...
	public void fusedMapInvalid() {
		...
		ConnectableFluxion<Integer> p = Fluxion.range(1, 5).map(v -> (Integer)null).publish();

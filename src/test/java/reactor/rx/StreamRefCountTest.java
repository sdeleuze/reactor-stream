...
public class StreamRefCountTest {
	...
	public void normal() {
		...
		Stream<Integer> p = sp.publish().refCount();
	...
	public void normalTwoSubscribers() {
		...
		Stream<Integer> p = sp.publish().refCount(2);
	...
	public void upstreamCompletes() {
		...
		Stream<Integer> p = Stream.range(1, 5).publish().refCount();
	...
	public void upstreamCompletesTwoSubscribers() {
		...
		Stream<Integer> p = Stream.range(1, 5).publish().refCount(2);

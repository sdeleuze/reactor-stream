...
public class FluxionZipIterableTest {

	@Test(expected = NullPointerException.class)
	public void sourceNull() {
		new FluxionZipIterable<>(null, Collections.emptyList(), (a, b) -> a);
	}

	@Test(expected = NullPointerException.class)
	public void iterableNull() {
		new FluxionZipIterable<>(Fluxion.never(), null, (a, b) -> a);
	}

	@Test(expected = NullPointerException.class)
	public void zipperNull() {
		new FluxionZipIterable<>(Fluxion.never(), Collections.emptyList(), null);
	}
	...
	public void normalSameSize() {
		...
		new FluxionZipIterable<>(new FluxionRange(1, 5),
	...
	public void normalSourceShorter() {
		...
		new FluxionZipIterable<>(new FluxionRange(1, 4),
				Arrays.asList(10, 20, 30, 40, 50), (a, b) -> a + b).subscribe(ts);
	...
	public void sourceEmpty() {
		...
		new FluxionZipIterable<>(new FluxionRange(1, 0),
				Arrays.asList(10, 20, 30, 40), (a, b) -> a + b).subscribe(ts);

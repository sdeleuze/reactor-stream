...
In this other exercise, we will focus more on the composition power in your hands with *Reactor Stream* project. A
classic use-case is to build self-healing data pipelines using the http://martinfowler.com/bliki/CircuitBreaker.html[Circuit Breaker Pattern] (maybe soon available in `Stream` API, maybe).
